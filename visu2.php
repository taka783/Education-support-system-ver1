...
<ul class="sub">
<?php
$jo1 = mysqli_query($con, "SELECT Learn FROM Reflection WHERE user_id='". $username . "'");
$row = mysqli_fetch_row($jo1);
$Jo1 = $row[0];
$jo2 = mysqli_query($con, "SELECT Notice FROM Reflection WHERE user_id='". $username . "'");
$row = mysqli_fetch_row($jo2);
$Jo2 = $row[0];
$jo3 = mysqli_query($con, "SELECT Improvement FROM Reflection WHERE user_id='". $username . "'");
$row = mysqli_fetch_row($jo3);
$Jo3 = $row[0];
?>
<table class="ta1">
<tr>
<th colspan="2" class="tamidashi">前回の振り返り</th>
</tr>
<tr>
<th width="30%">学びについて感じたこと</th>
<td width="70%"><?php echo $Jo1; ?></td>
</tr>
